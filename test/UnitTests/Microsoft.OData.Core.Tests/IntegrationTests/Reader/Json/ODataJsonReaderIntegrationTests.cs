//---------------------------------------------------------------------
// <copyright file="ODataJsonReaderIntegrationTests.cs" company="Microsoft">
...
{
    public class ODataJsonReaderIntegrationTests
    {
        ...
        static ODataJsonReaderIntegrationTests()
        {
        ...
        {
            var actual = ReadJsonEntry(payload, FullMetadata, readingResponse: true, enableReadingODataAnnotationWithoutPrefix: enableReadingODataAnnotationWithoutPrefix);
        ...
        public void ShouldBeAbleToReadTransientEntryInFullMetadataLevel()
        {
            ...
            var actual = ReadJsonEntry(payload, FullMetadata, readingResponse: true);
        ...
        {
            const string payload = "{" + ContextUrl + ",\"@odata.id\":null}";
            var actual = ReadJsonEntry(payload, MinimalMetadata, readingResponse: true);
            Assert.True(actual.IsTransient);
        }
        ...
        {
            var actual = this.ReadJsonEntry(payload, FullMetadata, readingResponse: false, enableReadingODataAnnotationWithoutPrefix: odataSimplified);
        ...
        public void LinkReadingResponseShouldBeReadAsAbsoluteForJsonEntry()
        {
            const string payload = "{" + ContextUrl + ", " +
                "\"@odata.editLink\": \"http://www.example.com/defaultService.svc/edit\", " +
                "\"@odata.id\":\"entryId\"}";
            var actual = this.ReadJsonEntry(payload, FullMetadata, readingResponse: true);
        ...
        {
            var actual = this.ReadJsonEntry(payload, FullMetadata, readingResponse: true, enableReadingODataAnnotationWithoutPrefix: enableReadingODataAnnotationWithoutPrefix);
            Assert.Equal(CreateUri("http://www.example.com/defaultService.svc/entryId"), actual.Id);
        ...
        public void LinkReadingRequestShouldBeTheSameForJsonFeed()
        {
            const string payload =
                "{" +
                    ...
                    "]" +
                "}";
            var entries = this.ReadJsonFeed(payload, MinimalMetadata, readingResponse: false);
        ...
        public void LinkReadingResponseShouldBeReadAsAbsoluteForJsonFeed()
        {
            const string payload =
                "{" +
                    ...
                    "]" +
                "}";
            var entries = this.ReadJsonFeed(payload, MinimalMetadata, readingResponse: true);
        ...
        public void UnknownAnnotationRequestShouldBeIgnored()
        {
            const string payload = "{" + ContextUrl + ", " +
                ...
                "\"@odata.id\":\"entryId\"}";
            var actual = this.ReadJsonEntry(payload, FullMetadata, readingResponse: false);
            Assert.Equal(CreateUri("entryId"), actual.Id);
        }
        ...
        [Fact]
        public void ReadingPayloadOpenComplexTypeJson()
        {
            EdmModel model = new EdmModel();
        ...
        [Fact]
        public void ReadingPayloadOpenComplexTypeJson_WithComplex()
        {
            EdmModel model = new EdmModel();
        ...
        private ODataResource ReadJsonEntry(string payload, string contentType, bool readingResponse, bool enableReadingODataAnnotationWithoutPrefix = false)
        {
        ...
        private IList<ODataResource> ReadJsonFeed(string payload, string contentType, bool readingResponse)
        {
