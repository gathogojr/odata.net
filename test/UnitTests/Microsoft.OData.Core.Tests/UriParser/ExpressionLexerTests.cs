...
namespace Microsoft.OData.Tests.UriParser
{
    public class ExpressionLexerTests
    {
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "null", false, false);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "#$*@#", false, false);
            ExpressionToken resultToken;
            Exception error = null;
            bool result = lexer.TryPeekNextToken(out resultToken, out error);
            Assert.False(result);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "5", false, false);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "2014-09-19T12:13:14+00:00", false, false);
            object result = lexer.ReadLiteralToken(this.model);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "2014-09-19", false, false);
            object result = lexer.ReadLiteralToken(this.model);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "12:30:03.900", false, false);
            object result = lexer.ReadLiteralToken(this.model);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "12:30:03", false, false);
            object result = lexer.ReadLiteralToken(this.model);
            var timeOfDay = Assert.IsType<TimeOfDay>(result);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, int.MaxValue + "000", false, false);
            object result = lexer.ReadLiteralToken(this.model);
        ...
        public void ShouldReturnLiteralWhenNoSuffixLiteralTokenFloat()
        {
            ...
            ExpressionLexer lexer = new ExpressionLexer(this.model, "123.001", false, false);
            object result = lexer.ReadLiteralToken(this.model);
        ...
        {
            // significant figures: float is 7, double is 15/16, decimal is 28
            ExpressionLexer lexer = new ExpressionLexer(this.model, "1234567.001", false, false);
            object result = lexer.ReadLiteralToken(this.model);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "3258.678765765489753678965390", false, false);
            object result = lexer.ReadLiteralToken(this.model);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "potato", false, false);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "misomethingk", true, false);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "m.i.something.k", true, false);
            string result = lexer.ReadDottedIdentifier(false).ToString();
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "2.43", false, false);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "m.*", true, false);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "m.*.blah", true, false);
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(this.model, "null", true, false);
        ...
        {
            ExpressionLexer l = new ExpressionLexer(this.model, "id1.id2.id3(", moveToFirstToken: true, useSemicolonDelimiter: false);
        ...
        {
            ExpressionLexer l = new ExpressionLexer(this.model, "id1(", moveToFirstToken: true, useSemicolonDelimiter: false);
            Assert.True(l.ExpandIdentifierAsFunction());
        ...
        {
            Action lex = () => new ExpressionLexer(this.model, "@", moveToFirstToken: true, useSemicolonDelimiter: false);
        ...
        {
            Action lex = () => new ExpressionLexer(this.model, "@", moveToFirstToken: true, useSemicolonDelimiter: false, parsingFunctionParameters: true);
            lex.Throws<ODataException>(Error.Format(SRResources.ExpressionLexer_SyntaxError, 1, "@"));
        }
        ...
        {
            Action lex = () => new ExpressionLexer(this.model, "@1", moveToFirstToken: true, useSemicolonDelimiter: false, parsingFunctionParameters: true);
        ...
        {
            return new ExpressionLexer(edmModel, text, moveToFirstToken: false, useSemicolonDelimiter: true, parsingFunctionParameters: false);
        }
