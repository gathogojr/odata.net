...
namespace Microsoft.OData.Tests.UriParser.Parsers
{
    ...
    public class SelectExpandTermParserTests
    {
        ...
        {
            var lexer = new ExpressionLexer(EdmCoreModel.Instance, term, true /*moveToFirstToken*/, true/*useSemicolonDelimiter*/);
        ...
        {
            lexer = new ExpressionLexer(EdmCoreModel.Instance, term, true /*moveToFirstToken*/, true/*useSemicolonDelimiter*/);
