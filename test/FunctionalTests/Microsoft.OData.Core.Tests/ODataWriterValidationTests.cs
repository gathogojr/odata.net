...
#if NETCOREAPP3_1_OR_GREATER
            await using (var jsonOutputContext = new ODataJsonLightOutputContext(messageInfo, this.messageWriterSettings))
#else
            using (var jsonOutputContext = new ODataJsonLightOutputContext(messageInfo, this.messageWriterSettings))
#endif
            {
