...
namespace Microsoft.OData.UriParser
{
    ...
    internal static class FunctionParameterParser
    {
        ...
        {
            ExpressionLexer lexer = new ExpressionLexer(configuration.Model, parenthesisExpression, true /*moveToFirstToken*/, false /*useSemicolonDelimiter*/, true /*parsingFunctionParameters*/);
