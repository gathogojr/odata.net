...
namespace Microsoft.OData.Json
{
    ...
    {
        /// <summary>
        /// Writes the json object value to the <paramref name="jsonWriter"/> asynchronously.
        /// </summary>
        ...
        internal static async Task WriteJsonObjectValueAsync(this IJsonWriterAsync jsonWriter, IDictionary<string, object> jsonObjectValue, Action<IJsonWriterAsync> injectPropertyAction)
        {
        ...
        /// <summary>
        /// Writes a primitive value asynchronously.
        /// </summary>
        /// <param name="jsonWriter">The <see cref="JsonWriter"/> to write to.</param>
        ...
        /// <summary>
        /// Writes the ODataValue (primitive, collection or resource value) to the underlying json writer asynchronously.
        /// </summary>
        /// <param name="jsonWriter">The <see cref="JsonWriter"/> to write to.</param>
        ...
        /// <summary>
        /// Writes the json array value asynchronously.
        /// </summary>
        /// <param name="jsonWriter">The <see cref="JsonWriter"/> to write to.</param>
        ...
        /// <summary>
        /// Writes the json value (primitive, IDictionary or IEnumerable) to the underlying json writer asynchronously.
        /// </summary>
        /// <param name="jsonWriter">The <see cref="JsonWriter"/> to write to.</param>
